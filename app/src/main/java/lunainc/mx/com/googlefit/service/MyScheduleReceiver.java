...
public class MyScheduleReceiver extends BroadcastReceiver {
    ...
    private static final String ALARM_ID = "com.lunainc.fitdata.MyScheduleReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (currentTime - UserPreferences.getLastSync(context) < (REPEAT_TIME * 2) && intent.getAction().equals("com.lunainc.fitdata.START_REFRESH")) {
        ...
        if (intent.getAction().equals("android.intent.action.BOOT_COMPLETED")
                ...
                || intent.getAction().equals("com.lunainc.fitdata.START_REFRESH")){
