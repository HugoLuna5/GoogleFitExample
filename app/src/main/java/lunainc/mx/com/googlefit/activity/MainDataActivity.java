...
public class MainDataActivity extends BaseActivity implements SearchView.OnQueryTextListener,
    ...
    public static final String ACTION_ADD_ACTIVITY = "com.lunainc.fitdata.ADD_ACTIVITY";
    public static boolean active = false;
    protected DataManager mDataManager;

    private TabPagerDataAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TabPagerDataAdapter(this.getSupportFragmentManager());
        ...
        Intent intent = new Intent("com.lunainc.fitdata.START_REFRESH");
        sendBroadcast(intent);

        if (ACTION_ADD_ACTIVITY.equals(getIntent().getAction())) {
            // Invoked via the manifest shortcut.
            AddEntryActivity.launch(MainDataActivity.this, 3);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_history:
                RecentActivity.launch(MainDataActivity.this);
                break;
    ...
    public void restoreDatabase() {
        ...
        Log.d("MainDataActivity", "Restoring database.");
        try {
            File sd = Environment.getExternalStorageDirectory();
            File data = Environment.getDataDirectory();

            if (sd.canWrite()) {
                String backupDBPath = "//data//com.lunainc.fitdata//databases//googlefitexample.db";
                ...
                if (currentDB.exists()) {
                    ...
                    src.close();
                    dst.close();
                    Log.d("MainDataActivity", "Database restored.");
                } else {
                    Log.d("MainDataActivity", "Database doesn't exist.");
                }
            }else {
                Log.d("MainDataActivity", "Unable to write file.");
            }
        } catch (Exception e) {
            Log.d("MainDataActivity", "Exception restoring database");
        }
    }
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        Log.d("MainDataActivity", "Query text: " + newText);
        return false;
    }
    ...
    void showAddEntryFragment(View view) {
        ...
        AddEntryActivity.launch(MainDataActivity.this, activityType);
    ...
    public void launch(View transitionView, Workout workout) {
        ...
        DetailDataActivity.launch(MainDataActivity.this, transitionView, workout);
    }
